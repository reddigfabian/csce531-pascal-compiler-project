...
# Perl script for testing CSCE 531 project 2 submissions (assignments & fcns)

# Usage (must be run in the parent directory of pas-proj2):
# $ proj2-test.pl --self-test

# Writes to file "pas-proj2comments.txt" in your directory
